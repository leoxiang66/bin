  ...
  try:
      ...
      # 如果我们文本输错，提示你是不是要找xxx的话，那么重新把xxx正确的翻译之后返回
          try:
              ...
              print(correctText)
              correctUrl=buildUrl(correctText,js.getTk(correctText),'en')
...
# outputs from google translation 
print('\n\n----------------------------------------------')
print('\nCN:',flush=1)
for i in contents:
  print(translate(i,'zh'))
print('',end='',flush=True) 

print('\n----------------------------------------------')
print('\nEN:',flush=1)
for i in contents:
  print(translate(i,'en'))
print('',end='',flush=True) 
